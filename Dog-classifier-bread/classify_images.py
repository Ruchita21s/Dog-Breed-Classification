...
#                                                                             
# PROGRAMMER:     Ruchita Soni
# DATE CREATED:   29th JUNE 2024                              
# REVISED DATE: 
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       model_label = classifier(images_dir + key, model).lower().strip() # Converting to lowercase, removing leading and trailing whitespaces
